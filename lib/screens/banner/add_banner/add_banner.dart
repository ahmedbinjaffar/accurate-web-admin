    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              'Adding the banner image. Please wait a moment; this might take a bit of time',
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    if (appProvider.bannerCount >= 5) {
                      showMessage('You can only add up to 5 banners');
                      return;
                    }
                    ...
                    if (!isUploading) {
                      if (image != null) {
                        ...
                        try {
                          appProvider.addBanner(
                            image!,
                          );
                          showMessage('Added Successfully');
                          Navigator.of(context).pop();
                          Routes.instance.push(
                              widget: const BannerView(), context: context);
                        } catch (error) {
