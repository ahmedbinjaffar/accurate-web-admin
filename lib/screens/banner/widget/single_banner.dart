...
class SingleBannerItem extends StatefulWidget {
  ...
  @override
  State<SingleBannerItem> createState() => _SingleBannerItemState();
}

class _SingleBannerItemState extends State<SingleBannerItem> {
          ...
          child: Container(
            ...
            child: ClipRRect(
              ...
              child: CachedNetworkImage(
                imageUrl: widget.singleBanner.image,
      ...
      builder: (context) {
        return ConfirmDeleteDialog(
          onConfirm: () async {
            ...
            await appProvider.deleteBannerFromFirebase(widget.singleBanner);
